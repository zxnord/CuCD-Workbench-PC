#include "subwindowplot.h"
#include "ui_subwindowplot.h"

SubWindowPlot::SubWindowPlot(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::SubWindowPlot)
{
    ui->setupUi(this);

    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////// Estracto de QCustomPlot Interaction Example ////////////////////////////////////////////////
...
SubWindowPlot::~SubWindowPlot()
{
    delete ui;
}

void SubWindowPlot::titleDoubleClick()
{
...
void SubWindowPlot::axisLabelDoubleClick(QCPAxis *axis, QCPAxis::SelectablePart part)
{
...
void SubWindowPlot::legendDoubleClick(QCPLegend *legend, QCPAbstractLegendItem *item)
{
...
void SubWindowPlot::selectionChanged()
{
  /*
...
void SubWindowPlot::addRandomGraph()
{
...
void SubWindowPlot::removeSelectedGraph()
{
...
void SubWindowPlot::removeAllGraphs()
{
  ui->customPlot->clearGraphs();
  ui->customPlot->replot();
}

void SubWindowPlot::contextMenuRequest(QPoint pos)
{
...
void SubWindowPlot::graphClicked(QCPAbstractPlottable *plottable)
{
